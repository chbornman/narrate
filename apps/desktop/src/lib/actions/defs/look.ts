 ...
 * pointer facts over the same Actions), and R member flip (featureset
 * §5). The filmstrip row moved to defs/global.ts (founder, June 12 2026:
 * F is total across Grid and Look). The look-backdrop seat is complete by construction:
